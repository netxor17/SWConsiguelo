    ...
    <nav>
        ...
        <ul class="profile">
            ...
            if (isset($_SESSION["login"]) && ($_SESSION["login"]===true)) {
                ...
                <li>Bienvenido, <?php echo $_SESSION['username'];?></li><li><a href="vistaCarrito.php">Carrito</li><li><a href="logout.php">(salir)</a></li>
            <?php
            } else {
            ?>
